...
<body>
    <nav class="navbar navbar-dark bg-dark">
        ...
        <p id="titulo_geral">Listagem de Produtos</p>
    </nav>
    ...
    <div id="container_cadastrado2">
      <h3>Categorias </h3>
      <h4 style="display: inline;"> <a href="categoria1.php">1</a> </h4> -
      <h4 style="display: inline;"> <a href="categoria2.php">2</a> </h4> -
      <h4 style="display: inline;"> <a href="categoria3.php">3</a> </h4> -
      <h4 style="display: inline;"> <a href="categoria4.php">4</a> </h4> 
        <table cellpadding="10px" class="table">
            ...
            include("conecta.php");
            $seleciona=mysqli_query($con, "select * from produtos order by categoria_id asc");
